...
import com.melihilhan.marveluniverseapp.databinding.ActivityCharacterBinding
                    ...
                    when{
                        ...
                        it.characterDetail.isNotEmpty()->{
                            ...
                            it.characterDetail.map { character ->
                                ...
                                Picasso.get().load(url).placeholder(R.drawable.image).into(binding.appCompatImageView)
